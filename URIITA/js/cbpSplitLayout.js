...
(function () {
	...
	function init() {
		...
		splitlayout.querySelector('span.back-left').addEventListener(eventtype, backToIntro);
		splitlayout.querySelector('span.back-right').addEventListener(eventtype, backToIntro);
	}
