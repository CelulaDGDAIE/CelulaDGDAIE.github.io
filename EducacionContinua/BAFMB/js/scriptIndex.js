...
function cambiarDiapositiva(){
	...
	if(carruselInformacionDiapositivaActual == "presentacion"){
		...
		document.getElementById("divUnidad").style.display="block";
		document.getElementById("imagenPresentacion").style.display="none";
		document.getElementById("imagenUnidad").style.display="block";
		...
		document.getElementById("divUnidad").style.display="none";
		document.getElementById("divPresentacion").style.display="block";
		document.getElementById("imagenPresentacion").style.display="block";
		document.getElementById("imagenUnidad").style.display="none";
